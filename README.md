...
> A curated list of Internet of Things tools and resources.
...
## License
Shared under Creative Commons license. A CC license is used when an author wants to give other people the right to share, use, and build upon a work that he or she (that author) has created.
